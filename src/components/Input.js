  ...
  return (
    <div className="flex items-center justify-center ">
      <div className="flex flex-col items-center justify-center w-5/6 mt-5">
        ...
        <form id="measurements" className="my-10 grid grid-cols-2 gap-5 px-10 w-full">
          <input
        ...
        <button
          className="my-20 w-1/2 text-white font-semibold block py-2 bg-blue-500 rounded-lg text-m shadow-lg focus:outline-none hover:bg-gray-100 hover:ring-2 hover:ring-blue-500 hover:text-blue-500"
          type="submit"
          form="measurements"
          onClick={onSubmit}
        >
